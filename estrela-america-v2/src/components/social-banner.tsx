    ...
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gradient-to-br from-[#0693e3] to-via-400 to-cyan-400 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <div className="w-full flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
        <div className="flex justify-start text-center pr-16">
          <Link href="#">
            <span className="flex items-center gap-2 text-lime-200 text-[13px] leading-4 font-semibold hover:underline focus:underline">
        ...
        <div className="hidden sm:inline-flex sm:items-center sm:gap-1 sm:pr-10">
